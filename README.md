...
Topvisor из CSV/XLSX, стабильные синтетические данные Метрики и Вебмастера и ручной
журнал выполненных работ. Расчёты и экспорт намеренно не входят в этот срез.
